        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoDeSangre = table.Column<string>(nullable: true),
                    Nacionalidad = table.Column<string>(nullable: true),
                    Religion = table.Column<string>(nullable: true),
                    Telefono = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    Direccion = table.Column<string>(nullable: true),
                    SalarioMensual = table.Column<int>(nullable: false),
                    Departamento = table.Column<string>(nullable: true),
                    NombreEmergencia = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Empeados", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Telefono = table.Column<string>(nullable: true),
                    Email = table.Column<string>(nullable: true),
                    NombreDePadre = table.Column<string>(nullable: true),
                    NombreDeMadre = table.Column<string>(nullable: true),
                    Direccion = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Direccion = table.Column<string>(nullable: true),
                    Carrera = table.Column<string>(nullable: true),
                    TituloCarreraGrado = table.Column<string>(nullable: true),
                    MayorGradoAcademico = table.Column<string>(nullable: true),
                    CategoriaProfesoral = table.Column<string>(nullable: true),
                    Facultad = table.Column<string>(nullable: true),
                    AsignaturaImpartidas = table.Column<string>(nullable: true),
                    Observaciones = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
